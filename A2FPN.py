'''
 -FPN for Semantic Segmentation of Fine-Resolution Remotely Sensed Images
'''
import torch
...
class A2FPN(nn.Module):
    def __init__(
        ...
        self.final_conv = nn.Conv2d(segmentation_channels * 4, nclass, kernel_size=1, padding=0)
